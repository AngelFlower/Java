...
public class Conversiones_1 {
	...
	public static void main(String[] args) {
		...
		switch (a) {
			case 1:
				System.out.println("TENGO VARIOS TIPOS DE CONVERSI�N DE MASA");
				...
				switch (b) {
					...
					case 4:
						...
						break;
					default:
						System.out.println("Esa conversi�n no la puedo hacer :((((");

				}
				break;

			case 2:
				System.out.println("TENGO VARIOS TIPOS DE CONVERSI�N DE VOLUMEN");
			...
			case 3:
				System.out.println("TENGO VARIOS TIPOS DE CONVERSI�N DE LONGITUD");
			...
			default:
				System.out.println("Esa conversi�n no la puedo hacer disculpa :(((");
		}
	}
}